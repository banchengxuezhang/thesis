$(function () {
    ...
    $("#modifyInfo").change(function () {
        ...
        if (status) {
            ...
            $("#teacherNotes").attr("readonly", false);
            $("#studentNotes").attr("readonly", false);
            $("#managerNotes").attr("readonly", false);
...
function commitInfo() {
    ...
    let teacherNotes=$("#teacherNotes").val();
    let studentNotes=$("#studentNotes").val();
    let managerNotes=$("#managerNotes").val();
    ...
    let data = {studentNum: studentNum, teacherNum: teacherNum,teacherGive:teacherGive,notesForTeacher:teacherNotes,notesForStudent:studentNotes,notesForManager:managerNotes};
    $.ajax({
        type: "post",
...
function loadData() {
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#teacherNotes").val(data.data.notesForTeacher);
            $("#studentNotes").val(data.data.notesForStudent);
            $("#managerNotes").val(data.data.notesForManager)
        },
        error: function () {
